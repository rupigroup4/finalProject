...
public class DBservices
{
    ...
    private String BuildInsertCommand(Customer customer)
    {
        ...
        String prefix = "INSERT INTO Customer_igroup4 " + "(firstName,sureName,phoneNumber,gender,birthday,email,img,joinDate,AgentID) OUTPUT Inserted.CustomerID ";
    ...
    public int ReadMessage( int customerID)
    {
        ...
        String rStr = "update badge_igroup4 set agentNewMessage=0 where customerId=" + customerID;
